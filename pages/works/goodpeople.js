...
export default () => (
  <Work>
    ...
    <div className='container'>
      ...
      <p>We needed to improve the checkout conversion rate. In order to do this we studied industry benchmarks with <strong>SimilarWeb</strong> and the funnels within GoodPeople with <strong>Google Analytics</strong> and <strong>Kissmetrics</strong>.</p>
    </div>
    ...
    <div className='container'>
      ...
      <p>With the goal to retain the UI simpler we focused on studying behaviour surrounding the options for shopping and the “Buy” button. In order to define its shape, wording and color options were tested with using an Invision prototype in <strong>usertesting.com</strong></p>
    </div>
